...
BompText="No!!!... The block is broken...You lose all the money!!"
...
#Draw Bridge
    ...
    extrainfo="Cross while the block is safe. Press Right Key"
    extrainfo1=""
    if Count==1:
        Bomp=False
        ...
        extrainfo="Next: Cross while the block is broken, Press Right Key"
...
#Text
    ...
    text7= font.render("Press KeyPad Enter to continue",True,BLACK)
    screen.blit(TommyBridge,[10, 10])
    screen.blit(text4, [500,650])
